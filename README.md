...
| zsh plugin submodules | `git submodule update --init --recursive` ile iner (Step 5, dosya-varlığı kontrolüyle). **Not:** `.zshrc` şimdilik bunları source ETMİYOR — yalnızca taşınıyorlar. |
